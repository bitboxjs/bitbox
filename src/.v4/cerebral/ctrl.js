const getByPath = require('cerebral/src/getByPath')
const CreateSignalFactory = require('cerebral/src/CreateSignalFactory.js')
const CreateRegisterModules = require('cerebral/src/CreateRegisterModules.js')
const Computed = require('cerebral/src/Computed')
const EventEmitter = require('events').EventEmitter
const ImmutableModel = require('cerebral/models/immutable')

var Controller = function(initState) {

	var controller = new EventEmitter()

	var Model = ImmutableModel(initState)
